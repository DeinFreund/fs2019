...
int main(int argc, char* argv[])
{
  ...
  auto problem = Korali::Problem::Posterior(likelihood);
  ...
  p.nCandles = 3;
  Korali::Parameter::Gaussian c1x("Candle 1 X", 0.25, 0.05);
  Korali::Parameter::Uniform c1y("Candle 1 Y", 0.0, 1.0);
  Korali::Parameter::Gaussian c2x("Candle 2 X", 0.75, 0.05);
  Korali::Parameter::Uniform c2y("Candle 2 Y", 0.0, 1.0);
  Korali::Parameter::Gaussian c3x("Candle 3 X", 0.75, 0.05);
  Korali::Parameter::Uniform c3y("Candle 3 Y", 0.0, 1.0);

  c1x.setBounds(0.0, 0.5 + 0.5 * (p.nCandles == 1));
  c2x.setBounds(0.5, 1.0);
  c3x.setBounds(0.5, 1.0);
