...
typedef struct gridLevelStruct {
 ...
 double* fl; // Right hand side (external heat sources)
 double* Ul; // Main grid
 double* Unl; // Previous Jacobi grid
 double* Resl; // Residual Grid
 double* up; // Residual Grid
 double* down; // Residual Grid
 double* left; // Residual Grid
 double* right; // Residual Grid
